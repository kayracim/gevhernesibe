...
import { InteractiveMuseum } from "@/components/InteractiveMuseum";
...
export default async function VirtualTourPage({
  ...
  // Kayseri Selçuklu Uygarlığı Müzesi (Gevher Nesibe) Tanıtım/Belgesel Videosu
  const youtubeEmbedUrl = "https://www.youtube.com/embed/C7Nva84PsVQ?si=trthaber&autoplay=0&rel=0";
  ...
  return (
    <div className="space-y-16">
      ...
      <Section id="vr-tur" title={locale === "tr" ? "Müze Tanıtım Videosu" : "Museum Introduction Video"}>
      ...
      {/* İnteraktif Müze Keşif Paneli */}
      <Section id="interaktif-kesif" title={locale === "tr" ? "Külliye ve Müze Odaları Keşfi" : "Complex & Museum Rooms Explorer"}>
        <InteractiveMuseum locale={locale} />
      </Section>
    </div>
  );
}
